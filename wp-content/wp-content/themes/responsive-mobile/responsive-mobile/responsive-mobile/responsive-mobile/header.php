...
<div id="container-fl" class="site container-fluid">
	<div class="row">
...
<?php responsive_mobile_header_before(); ?>
	<header id="header" class="container-full-width site-header img-responsive" role="banner" itemscope="itemscope" itemtype="http://schema.org/WPHeader">
